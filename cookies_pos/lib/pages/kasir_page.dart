...
class _KasirPageState extends State<KasirPage>
              ...
              SizedBox(
                ...
                child: OutlinedButton.icon(
                  style: OutlinedButton.styleFrom(
                    ...
                    side: BorderSide(color: AppTheme.tertiary, width: 1.5),
                  ...
                  onPressed: () {
                    ...
                    _showPreOrderNameDialog();
                  },
                  icon: const Icon(Icons.calendar_month, size: 20),
                  label: const Text(
                    'Simpan sebagai Pre-Order',
          ...
          child: Column(
            ...
            children: [
              ...
              Container(
                ...
                child: Column(
                  children: [
                    ...(_cart.entries.where((e) => e.value > 0).map((entry) {
                      final product = _products.firstWhere(
                        (p) => p.id == entry.key,
                      );
                      return Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            Text(
                              _formatCurrency(product.price * entry.value),
                              style: TextStyle(
                                fontSize: 13,
                                fontWeight: FontWeight.w600,
                                color: AppTheme.onSurface,
              ...
              const SizedBox(height: 8),
              Text(
                'Metode pembayaran dipilih saat menyelesaikan pre-order',
                style: TextStyle(
                  fontSize: 11,
  ...
  Future<void> _savePreOrder() async {
    ...
    await DatabaseHelper().insertPreOrder(preOrder);
